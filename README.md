...
```
计算机视觉  ·  边缘 AI 部署  ·  大模型与多智能体（大模型底层架构 / MAS 多智能体系统）
```

专注从**模型训练 → 量化部署 → 边缘硬件落地 → 产品化**的完整链路，并对**大模型底层架构与多智能体协作（MAS）**保持持续研究。

## 开源贡献 🌟

| 项目 | 贡献 |
|------|------|
| [Sipeed PicoClaw](https://github.com/sipeed/picoclaw) | 28K+ ⭐ Go 语言 AI 助手 · 核心开发者，多 PR 已合并 |
...
| 项目 | 简介 | 技术栈 |
|------|------|--------|
| **Cell Vision Pro** | 千元级智能活细胞成像系统，产品负责人 + 全栈开发 | MaixPy · NestJS · React |
...
<tr>
  <th align="center">嵌入式</th>
  <td align="center">
    <img src="https://img.shields.io/badge/-MaixCAM%20%2F%20SG2002-2ECC71?style=flat-square&logo=ri&logoColor=white" />
...
[![GitHub stats](https://github-readme-stats.vercel.app/api?username=yangwenjie1231&show_icons=true&count_private=true&theme=vue-dark&rank_icon=github&hide_border=true)](https://github.com/yangwenjie1231)

[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=yangwenjie1231&layout=compact&theme=vue-dark&hide_border=true)](https://github.com/yangwenjie1231)
...
<div align="center">
  <sub>打开 <a href="https://github.com/yangwenjie1231">yangwenjie1231</a> 的主页即此仓库 README</sub>
</div>